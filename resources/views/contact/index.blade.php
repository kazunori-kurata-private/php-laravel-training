    ...
    <div class="mt-8">
      ...
      <form action="{{ route('contact') }}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input id="name" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border @error('name') border-red-500 @enderror" type="text" placeholder="例）田中太郎" name="name" value="{{ old('name') }}">
          @error('name')
        ...
        <div class="mb-4">
          ...
          <input id="name_kana" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border @error('name_kana') border-red-500 @enderror" type="text" placeholder="例）タナカタロウ" name="name_kana" value="{{ old('name_kana') }}">
          @error('name_kana')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
          @enderror
        </div>
        <div class="mb-4">
          ...
          <input id="phone" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border @error('phone') border-red-500 @enderror" type="text" placeholder="例）0312345678" name="phone" value="{{ old('phone') }}">
          @error('phone')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
          @enderror
        </div>
        <div class="mb-4">
          ...
          <input id="email" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border @error('email') border-red-500 @enderror" type="email" placeholder="info@example.com" name="email" value="{{ old('email') }}">
          @error('email')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
          @enderror
        </div>
        <div class="mb-4">
          ...
          <textarea id="body" class="w-full h-24 p-4 text-xs leading-none resize-none bg-blueGray-50 rounded outline-none border @error('body') border-red-500 @enderror" type="text" placeholder="ご自由にご記入ください" name="body">{{ old('body') }}</textarea>
          @error('body')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
          @enderror
        </div>
